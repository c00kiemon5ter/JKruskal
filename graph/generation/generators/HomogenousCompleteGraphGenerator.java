...
import graph.Node;
import graph.generation.DefaultVertexFactory;
 ...
 */
public class HomogenousCompleteGraphGenerator implements Generator<WeightedGraph<Node, DefaultWeightedEdge>> {
	...
	public HomogenousCompleteGraphGenerator() {
		/* Noop */
	}
